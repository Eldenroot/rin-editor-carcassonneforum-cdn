/** Upraveno pro 1.1.8 - pridana podpora pro: tabulky, podbarveni textu, vlozeni obrazku do editoru pomoci klavesove zkratky Ctrl+V
...
CKEDITOR.editorConfig = function( config ) {
	...
	config.extraPlugins = 'filetools,imgur_drag,notificationaggregator,uploadimage,uploadwidget,table';	
